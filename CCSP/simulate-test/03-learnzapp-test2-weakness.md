...
4. **Resume (恢復/復歸)：** 主要站點修好後，將業務從備援站點「切換回 (Failback)」主要站點，全面恢復正常營運。
**情境測驗 3：** 某個位於地震帶的雲端資料中心遭遇了規模 7.0 的強震。建築物部分受損，市電完全中斷，且兩家不同電信商的外部網路線路也因為橋樑斷裂而同時中斷。災難應變小組 (Incident Response Team) 剛剛抵達現場。
